 ...
 */
public class GlacierUploadTaskOutput implements TaskOutput {
    ...
    public GlacierUploadTaskOutput() {
        // required by service loader
    }

    public GlacierUploadTaskOutput(List<Hash> hashes) {
        this.hashes = hashes;
    }
    ...
    public String toString() {
        return "GlacierUploadTaskOutput{" +
                "hashes=" + hashes +
                '}';
    }
}
