 ...
 */
public class GlacierUploadTaskConfiguration extends AWSUploadTaskConfiguration {

    private static final String TASK_TYPE = "GLACIER_UPLOAD";

    public GlacierUploadTaskConfiguration() {
        // required by service loader
    }

    public GlacierUploadTaskConfiguration(URI source, URI destination, long partSize, List<AWSUploadPart> parts, List<String> hashAlgorithms) {
    ...
    public String toString() {
        return "GlacierUploadTaskConfiguration{" +
                "source=" + getSource() +
