...
/**
 * JAX-RS Exception mapper for org.projectomakase.omakase.exceptions.InvalidUUIDException. Returns a 404.
 *
...
public class InvalidUUIDExceptionMapper implements ExceptionMapper<InvalidUUIDException> {
    ...
    public Response toResponse(InvalidUUIDException exception) {
        return Responses.errorResponse(Response.status(Response.Status.NOT_FOUND).build(), "HTTP 404 Not Found", exception, false);
    }
}
