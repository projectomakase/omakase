...
/**
 * JAX-RS Exception mapper for org.projectomakase.omakase.exceptions.NotAuthorizedException. Returns a 404.
 *
...
public class NotAuthorizedExceptionMapper implements ExceptionMapper<NotAuthorizedException> {
    ...
    public Response toResponse(NotAuthorizedException exception) {
        ...
        return Responses.errorResponse(Response.status(Response.Status.FORBIDDEN).build(), "Not authorized", exception, LOGGER.isInfoEnabled());
    }
}
