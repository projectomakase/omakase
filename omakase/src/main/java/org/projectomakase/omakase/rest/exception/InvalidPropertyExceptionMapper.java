...
/**
 * JAX-RS Exception mapper for org.projectomakase.omakase.exceptions.InvalidPropertyException. Returns a 400.
 *
...
public class InvalidPropertyExceptionMapper implements ExceptionMapper<InvalidPropertyException> {
    ...
    private static final Logger LOGGER = Logger.getLogger(InvalidPropertyExceptionMapper.class);
