...
import org.projectomakase.omakase.content.AssetSearchBuilder;
 ...
 */
public class AssetQuerySearchConverter extends QuerySearchConverter {
    ...
    static {
        ...
        builder.put("id", Asset.ID);
        builder.put("name", Asset.ASSET_NAME);
        builder.put("external_ids", Asset.EXTERNAL_IDS);
        builder.put("created", Asset.CREATED);
        builder.put("created_by", Asset.CREATED_BY);
        builder.put("last_modified", Asset.LAST_MODIFIED);
        builder.put("last_modified_by", Asset.LAST_MODIFIED_BY);
        QUERY_ATTRIBUTE_MAP = builder.build();

        DATE_ATTRIBUTES = ImmutableList.of(Asset.CREATED, Asset.LAST_MODIFIED_BY);
    }
