 ...
 */
public class MessageSearchBuilder extends Search.Builder {
    ...
    static {
        SUPPORTED_SORT_ATTRIBUTES = ImmutableList.of(Message.TYPE, Message.CREATED);
        ImmutableMultimap.Builder<String, Operator> mapBuilder = ImmutableMultimap.builder();
        mapBuilder.put(Message.TYPE, Operator.EQ);
